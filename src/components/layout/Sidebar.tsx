...
import {
  ...
  StarIcon, BarChart3Icon, ShieldIcon, MenuIcon, XIcon, SettingsIcon,
  LogOutIcon, UserIcon
} from 'lucide-react'
      ...
      <ScrollArea className="flex-1 px-3 py-3">
        ...
        {currentPoolId && (
          <>
            ...
            <p className="px-2 py-1 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Esta quiniela</p>
        ...
        {profile.role === 'super_admin' && (
          <>
            <Separator className="my-3" />
            <p className="px-2 py-1 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Admin</p>
            <nav className="mt-1 space-y-0.5">
